    ...
    public class JsonMapper
    {
        ...
        private static object ReadValue (Type inst_type, JsonReader reader)
        {
            ...
            if (reader.Token == JsonToken.ArrayStart) {
                ...
                {
                    // 如果对应的类没有提供默认的构造函数，则使用 GetUninitializedObject() 方法不通过构造函数构造相应的对象
                    instance = System.Runtime.Serialization.FormatterServices.GetUninitializedObject(value_type);
                }
